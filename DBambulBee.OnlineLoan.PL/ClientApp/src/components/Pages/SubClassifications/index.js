...
import ListSubClassifications from "./ListSubClassifications";
import AddMainClassification from "./AddSubClassification";
							...
							<div className="row mb-2">
								...
								<div className="col-sm-6">
									<ol className="breadcrumb float-sm-right">
										...
										<li className="breadcrumb-item active">Sub Classifications</li>
									</ol>
								</div>
							</div>
						</div>
							...
							<div className="col-md-12">
								<div className="card card-outline card-primary">
									<div className="card-header">
										<h1 className="card-title"><b>Sub Classifications</b></h1>
									</div>
